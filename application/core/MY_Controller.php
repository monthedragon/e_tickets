...
class Auth_Controller extends CI_Controller {
	...
	function set_header_data($title='ACQUI',$sub_title='',$no_header=false){
		...
		if($no_header){
			$data['no_header'] = true; //dont show header if set
		}
	...
	function get_users_grp_by_id($user_type=''){
		$retVal = array();
		...
		$result = $this->db->order_by('firstname,lastname')->get()->result_array();
